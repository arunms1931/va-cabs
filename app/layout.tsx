...
export const metadata: Metadata = {
  ...
  description:
    "Book direct cab rides with VA Cabs in Thirumazhisai and Chennai. We provide reliable local travel, airport transfers, planned journeys, and outstation trips. Call or WhatsApp +91 92834 55152 to book.",
  keywords:
